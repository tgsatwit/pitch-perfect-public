...
import type { GraphInput } from "@opencanvas/shared/types";
...
export function CanvasComponent({ assistantId, user, createdPitchId, handleSaveAndProceed }: CanvasComponentProps) {
  ...
  const handleStreamMessage = async (params: GraphInput): Promise<void> => {
    // Empty implementation as we don't need streaming functionality for the save button
    return Promise.resolve();
  };

  return (
    <ResizablePanelGroup direction="horizontal" className="h-[calc(100vh-10px)]">
      {!chatStarted && (
        <NoSSRWrapper>
...
const CanvasMemo = React.memo(CanvasComponent);

export const Canvas = (props: CanvasComponentProps) => (

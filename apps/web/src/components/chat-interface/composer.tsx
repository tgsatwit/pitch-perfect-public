...
const GENERIC_PLACEHOLDERS = [
  "How would you like to refine your pitch?",
];
...
export const Composer: FC<ComposerProps> = (props: ComposerProps) => {
  ...
  return (
    <DragAndDropWrapper>
      <ComposerPrimitive.Root className="focus-within:border-aui-ring/20 flex flex-col w-full min-h-[70px] flex-wrap items-center justify-center border px-2.5 shadow-sm transition-colors ease-in bg-white rounded-2xl z-10">

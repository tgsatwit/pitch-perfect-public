...
export const Thread: FC<ThreadProps> = (props: ThreadProps) => {
  ...
  return (
    <ThreadPrimitive.Root className="flex flex-col h-full w-full">
      <div className="pr-3 pb-2 flex flex-row gap-4 items-center justify-between">
        <div className="flex items-center justify-start gap-2 text-gray-600">
          <TighterText className="text-2xl font-bold text-slate-800">Build Outline</TighterText>
        </div>
      </div>

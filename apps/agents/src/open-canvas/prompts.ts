...
If a user asks you to generate something completely different from the current artifact, advise them that you can't do that, and that you can only edit the current artifact.

The user is currently in the "Build Outlines" feature.
</app-context>
`;
